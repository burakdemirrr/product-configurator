...
export function ControlsUI() {
  ...
  return (
    <div className="w-full max-w-xs bg-gray-800/90 backdrop-blur-md p-6 rounded-lg shadow-lg border border-gray-700">
      <h2 className="text-xl font-bold mb-4 text-white">Customize Product</h2>
      
      {/* Model Scale Control */}
      <div className="mb-5 pb-4 border-b border-gray-600">
        <h3 className="text-gray-200 text-sm font-semibold mb-2">Model Scale</h3>
      ...
      <div className="mb-4 pb-4 border-b border-gray-600">
        <label className="block text-gray-200 text-sm font-semibold mb-2" htmlFor="color">
          Color
        </label>
        <div className="flex items-center">
          <div 
            className="w-10 h-10 rounded-md overflow-hidden cursor-pointer border border-gray-600"
            style={{ backgroundColor: color }}
            onClick={() => setShowColorPicker(!showColorPicker)}
          ></div>
          <span className="ml-3 text-sm text-gray-300">{color}</span>
        </div>
        
        {showColorPicker && (
          <div className="mt-3 relative">
            <div className="absolute z-10 bg-gray-800 rounded-md shadow-xl p-3 border border-gray-700">
              ...
              <div className="flex justify-between mt-2">
                ...
                <button
                  className="px-2 py-1 bg-blue-800 hover:bg-blue-700 text-gray-200 text-xs rounded"
      ...
      {/* Metalness Slider */}
      <div className="mb-4">
        <label className="block text-gray-200 text-sm font-semibold mb-2" htmlFor="metalness">
      ...
      {/* Roughness Slider */}
      <div className="mb-4 pb-4 border-b border-gray-600">
        <label className="block text-gray-200 text-sm font-semibold mb-2" htmlFor="roughness">
      ...
      {/* Accessories Toggles */}
      <div className="mb-4">
        <h3 className="block text-gray-200 text-sm font-semibold mb-2">Accessories</h3>
          ...
          {accessoryList.map((accessory) => (
            <div key={accessory} className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-blue-600 bg-gray-700 rounded focus:ring-blue-500 focus:ring-offset-gray-800"
              />
      ...
      {/* Material Presets */}
      <div className="mb-4">
        <h3 className="block text-gray-200 text-sm font-semibold mb-2">Material Presets</h3>
