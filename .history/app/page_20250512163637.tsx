...
function ErrorBoundary({ children }: { children: React.ReactNode }) {
  ...
  if (hasError) {
    return (
      <div className="w-full h-full flex items-center justify-center bg-red-900/20 p-4 rounded-lg border border-red-800">
        <div className="text-center">
          <h2 className="text-xl font-bold text-red-400 mb-2">3D Rendering Error</h2>
          <p className="mb-4 text-gray-300">There was an error loading the 3D model.</p>
          <button 
      ...
      <Layout>
        <div className="flex flex-col md:flex-row gap-6">
          <div className="w-full md:w-3/4 relative">
            <div className="w-full h-[500px] md:h-[600px] bg-indigo-900/40 rounded-lg border border-teal-500/20"></div>
          </div>
  ...
  return (
    <Layout>
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-3/4 relative">
          <div className="w-full h-[500px] md:h-[600px] bg-indigo-900/40 rounded-lg border border-teal-500/20 shadow-xl shadow-teal-500/5 overflow-hidden relative">
            <ErrorBoundary>
              <CanvasScene />
            </ErrorBoundary>
          </div>
