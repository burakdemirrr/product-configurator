      ...
      <Layout>
        <div className="flex flex-col md:flex-row gap-6">
          <div className="w-full md:w-3/4 relative">
            <div className="w-full h-[500px] md:h-[600px] bg-gray-800 rounded-lg border border-gray-700"></div>
          </div>
  ...
  return (
    <Layout>
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-3/4 relative">
          <div className="w-full h-[500px] md:h-[600px] bg-gray-800 rounded-lg border border-gray-700 shadow-lg overflow-hidden relative">
            <ErrorBoundary>
              <CanvasScene />
            </ErrorBoundary>
          </div>
