...
export default function Home() {
  ...
  useEffect(() => {
    const handleVisibilityChange = () => {
      // Control animation based on document visibility
      const isVisible = !document.hidden;
      // Use isVisible state to control animations if needed
    };
      ...
      <Layout>
        <div className="flex flex-col md:flex-row gap-6">
          <div className="w-full md:w-3/4 relative">
            <div className="w-full h-[500px] md:h-[600px] bg-[#1E1E1E] rounded-lg border border-[#2A2A2A]"></div>
          </div>
  ...
  return (
    <Layout>
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-3/4 relative">
          <div className="w-full h-[500px] md:h-[600px] bg-[#1E1E1E] rounded-lg border border-[#2A2A2A] shadow-xl overflow-hidden relative">
            <ErrorBoundary>
              <CanvasScene />
            </ErrorBoundary>
          </div>
